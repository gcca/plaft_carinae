...
exports._display =[
  ...
  [['6', 'La persona en cuyo nombre se realiza la operación es: (1) proveedor del extranjero (ingreso de mercancía), (2) Importador (ingreso de mercancía),ó Exportador (salida de mercancía) ó Destinatario del embarque (salida de mercancía).', (c) -> 'FALTA CALCULAR']
  ['7', 'Tipo de persona: (1) Persona Natural ó (2) Persona Jurídica. Si consignó la opción (2) no llenar los items 08 al 13 ni los items del 15 al 22.', (c) -> c.'customer_type']
  ['8', 'Tipo de documento de identidad. Consignar el código de acuerdo a la Tabla N° 1.', (c) -> if c.'document_type' is 'ruc' then 'No aplica' else c.'document_type']
  ['9', 'Número de documento de identidad.', (c) -> if c.'document_type' is 'ruc' then 'No aplica' else c.'customer_number']
  ...
  ['27', 'Condición en la que interviene en la operación inusual: (1) Involucrado ó (2) Vinculado', -> 'FALTA']
